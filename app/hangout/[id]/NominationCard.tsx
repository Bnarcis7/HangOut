...
export default function NominationCard({ nomination, currentUserId, hangoutType }: NominationCardProps) {
    ...
    <div className="border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:border-gray-300 transition-colors">
      <div className="flex items-start justify-between mb-2 sm:mb-3 gap-3">
        <div className="flex-1 min-w-0">
          ...
          {hangoutType === 'RESTAURANT' && metadata && (
          ...
          {hangoutType === 'HOME_TAKEOUT' && metadata && (
            <div className="space-y-1.5 mb-3">
              {metadata.cuisine && (
                <div className="flex items-center gap-2 text-[12px] text-gray-600">
          ...
          {/* Drinks metadata */}
          {hangoutType === 'HOME_DRINKS' && metadata && (
            <div className="space-y-1.5 mb-3">
              {metadata.drinkType && (
                <div className="flex items-center gap-2 text-[12px] text-gray-600">
                  <span className="text-gray-400">🍹</span>
          ...
          {/* Games metadata */}
          {(hangoutType === 'HOME_GAMES' || hangoutType === 'GAME_NIGHT') && metadata && (
          ...
          {/* Movie metadata */}
          {hangoutType === 'MOVIE_NIGHT' && metadata && (
            <div className="flex items-center gap-3 mb-3 text-[12px] text-gray-600">
              {metadata.genre && (
                <div className="flex items-center gap-1.5">
                  <span className="text-gray-400">🎭</span>
          ...
          {(hangoutType === 'RESTAURANT' || hangoutType === 'HOME_TAKEOUT') && (
